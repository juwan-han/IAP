...
|2111, 2112|	When sending request to IAP server, check Content-type and HTTP Method.<br/> [링크](./Server Developer`s Guide) |
|5003, 5013|	Check if store sync information is issued in following steps. <br/> [링크](./Store interlocking information) |
