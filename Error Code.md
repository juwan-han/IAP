...
| 103 |  UNSUPPORTED_MARKET |  지원하지 않는 마켓 |
...
| 108 |  INAPP_INITIALIZED_ERROR |  마켓 결제 라이브러리 초기화 오류 |
| 109 |  INAPP_PURCHASE_ERROR |  마켓 결제 오류 - 구매 요청시 |
| 110 |  INAPP_VERIFY_SIGNATURE_ERROR |  마켓 결제 오류 - 서명 검증시 |
| 111 |  INAPP_CONSUME_ERROR |  마켓 결제 오류 - 결제 내역 소모시 |
| 112 |  INAPP_VERIFY_CONSUME_ERROR |  마켓 결제 검증 오류 - 영수증 검증 시 |
...
|---|---|---|
|1100|	INVALID_PARAMETERS|	파라미터 정보 오류|
|5003|	INVALID_AUTHENTICATED|	마켓 인증정보 오류|
...
|5003, 5013|	마켓 연동정보를 아래 절차로 발급받았는지 확인합니다. <br/> [링크](./Market interlocking information) |
