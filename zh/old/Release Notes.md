...
* [SDK][[Android-1.3.2](/Download/#common-iap)][[Unity-1.5.1](/Download/#common-iap)] 릴리스
    * [미처리 결제건 일괄 재처리](/Mobile Service/IAP/ko/Android%20Developer%60s%20Guide/#_9)시 앱 크래시 현상 수정
    * [구매 가능한 아이템 조회](/Mobile Service/IAP/ko/Android%20Developer%60s%20Guide/#_5)시 잘못된 응답값이 반환되는 문제 수정
	```
	변경 전: itmeSeq
	변경 후: itemSeq
	```
...
* [SDK][[Android-1.3.1](/Download/#common-iap)][[Unity-1.5.0](/Download/#common-iap)] 릴리스
    ...
    * <a href="/ko/Mobile Service/IAP/ko/Error%20Code/" target="_blank">Error Code Guide</a> 와 상이한 오류 코드 수정
